...
const FooterDark = (props) => {
  return (
    <footer
      className={`footer-dark-footer section-container ${props.rootClassName} `}
    >
      <div className="footer-dark-max-width max-content-container">
        <div className="footer-dark-bottom-container">
          <div className="footer-dark-left-side">
            <img
              alt="image"
              src="https://play.teleporthq.io/static/svg/placeholders/no-image.svg"
              className="footer-dark-image"
            />
            <span className="footer-dark-text">
            ...
            <div className="footer-dark-social-media">
              <span className="footer-dark-text01">Follow market1</span>
              <div className="footer-dark-container">
                <svg viewBox="0 0 1024 1024" className="footer-dark-icon">
                ...
                <svg viewBox="0 0 1024 1024" className="footer-dark-icon04">
                ...
                <svg viewBox="0 0 1024 1024" className="footer-dark-icon08">
                ...
                <svg viewBox="0 0 1024 1024" className="footer-dark-icon10">
          ...
          <div className="footer-dark-links">
            <div className="footer-dark-container1">
              <span className="footer-dark-text02">Product</span>
              ...
              <span className="footer-dark-text08 footer-link">Workshops</span>
            </div>
            <div className="footer-dark-container2">
              <span className="footer-dark-text09">
                <span>Contact</span>
                <br></br>
                <span></span>
              </span>
              ...
              <span className="footer-dark-text16 footer-link">sales</span>
            </div>
          </div>
        </div>
        <div className="footer-dark-copyright">
          <span className="footer-dark-text17">
            <span>
              <span>
                © All rights reserved
                <span
            ...
            >
              <span className="footer-dark-text21">@TeleportHQ.</span>
            </a>
            <span>
              <span>
                {' '}
            ...
            <a
              ...
              rel="noreferrer noopener"
            >
              <span className="footer-dark-text25">Vercel</span>
            </a>
            <span>
              <span>
                . Image source:
            ...
            <a
              ...
              rel="noreferrer noopener"
            >
              <span className="footer-dark-text29">Unsplash</span>
            </a>
            <span>.</span>
          </span>
        </div>
